...
window.addEventListener('load', function() {
    ...
    var headers = new Headers();
    headers.set('Accept', 'application/json');
    var url = 'http://localhost:8008/salary/user';
    var fetchOptions = {
        method: 'GET',
        headers
    };
    ...
    .then(function(jsonData) {
        ...
        for (var i=0; i<jsonData.length; i++) {
            ...
            salaryDiv.innerHTML = 
                `<div class="mb-1"> \
                    <button class="btn btn-outline-dark text-left col-12"> \
                        <div> \
                        ...
                        <div> \
                            ...
                            <button class="btn-sm btn-outline-success text-left" style="${actionButtonStyle}">確認收到</button> \
                        </div> \
                    </button> \
                </div>`;
